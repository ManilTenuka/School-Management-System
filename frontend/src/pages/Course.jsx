...
const Course = () => {
  ...
  <div className="mt-4">
    <p className="text-gray-700 text-md font-medium mt-1 px-2 text-center">{courses?.course_description || 'No description available'}</p>
      ...
      <div className="w-48 h-48 p-6 bg-white border border-gray-300 shadow-lg rounded-lg flex flex-col items-center justify-center text-center">
        <h2 className="text-xl font-semibold text-gray-800">Total Teachers Enrolled</h2>
            ...
            <tbody className="text-gray-700 text-sm">
              {teachers.map((teacher, index) => (
                <tr key={index} className="border-b hover:bg-gray-100">
                  ...
                  <td className="py-2 px-4 text-center flex gap-2 justify-center">
                    <button onClick={() => navigate(`/admin/teacher/${teacher.id}`)} className="text-blue-500 hover:text-blue-700">
                      <FaEye size={18} title="View" />
                    </button>
